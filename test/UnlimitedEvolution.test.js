...
contract('UnlimitedEvolution', function (accounts) {
  let ue, balance, balanceBefore, balanceAfter, eventInvestor, eventOwner, tokenIdInvestor, tokenIdOwner;
  ...
  describe('UE Tests', async () => {
    ...
    describe('Fight', async () => {
      ...
      it('Fighting', async function () {
        ...
        expectEvent(receipt, 'Fighted', { 
          myTokenId: tokenIdOwner, rivalTokenId: tokenIdInvestor, 
          substrateLifeToRival: receipt.logs[0].args[2], substrateLifeToMe: receipt.logs[0].args[3] 
        });
      })

      // // *********** TODO ****************
      // // spell(uint256 _myTokenId, uint256 _rivalTokenId)
      // // _generateRandomNum(uint256 _mod)
      // // substrateLife(uint256 id1, uint256 id2)
      // // substrateLifeMagic(uint256 id1, uint256 id2)
      // // XpLevelUp(uint256 _tokenId)
      // // sustrateLifeOperation(uint256 _myTokenId, uint256 _rivalTokenId, uint256 substrateLifeToRival, uint256 substrateLifeToMe)
      // // *********** END TODO ****************
      
      // it('REVERT: fight() Wrong amount of fees', async function () {
      //   await expectRevert(
      //     ue.fight(tokenIdOwner, tokenIdInvestor, { value: readable('0.00002'), from: owner }),
      //     'Wrong amount of fees',
      //   )
      // })
      ...
      //   await expectRevert(
      //     ue.fight(tokenIdOwner, tokenIdInvestor, { value: readable('0.00001'), from: investor }),
      ...
      //   await expectRevert(
      //     ue.fight(tokenIdOwner, tokenIdOwner2, { value: readable('0.00001'), from: owner }),
      ...
      //   await expectRevert(
      //     ue.fight(tokenIdOwner, tokenIdInvestor, { value: readable('0.00001'), from: owner }),
      ...
      //     await ue.fight(tokenIdOwner, tokenIdInvestor2, { value: readable('0.00001'), from: owner });
      //     await time.increase(61);
      ...
      //       expectEvent(receipt, 'LevelUp', { tokenId: tokenIdOwner, level: tokenDetailsOwner[2] })
      //       break;
      //     }
      //     receipt = await ue.fight(tokenIdOwner, tokenIdInvestor3, { value: readable('0.00001'), from: owner });
      //     await time.increase(61);
      ...
      //     await ue.fight(tokenIdOwner, tokenIdInvestor, { value: readable('0.00001'), from: owner });
      //     await time.increase(61);
    ...
    //     // console.log(tokenDetailsInvestorBefore[4])
    ...
    //     // console.log(tokenDetailsInvestorAfter[4])
    ...
    //     await expectRevert(
    //       ue.heal(tokenIdInvestor, { value: readable('0.00002'), from: investor }),
    //       'Wrong amount of fees',
    //     )
    //   })
    ...
    //     await expectRevert(
    //       ue.heal(tokenIdInvestor, { value: readable('0.00001'), from: investor }),
