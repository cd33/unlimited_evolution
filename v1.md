...
En fonction du nombre généré, des parties plus ou moins rares lui sont attribuées. 
  ...
  - Deux autres NFTs Stuffs sont crées et envoyés au demandeur, il s'agit d'une épée et d'un bouclier basique, premier équipement de son NFT qui ajoute des points de statistique au personnage.
...
* BuyStuff et EquipStuff permettent d'acheter et d'équiper du stuff.
